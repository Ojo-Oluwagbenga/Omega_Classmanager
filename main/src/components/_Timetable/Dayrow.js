...
class Dayrow extends Component {
  ...
  render() {
    return (
        <div className="row" given_index={this.props.index} given_code={this.props.rowdata.daycl_code}>
            <div col="status" className="texthold editbox c-vert">
                <div status={this.props.rowdata.status} className="actions">                                                   
                    <div style={{"backgroundColor": "green"}} onClick={this.thrower.bind(this, 'action', [1, this.props.id], this.props.super)} className="act c-vert nocolor-click">
                    ...
                    <div style={{"backgroundColor": "yellow"}} onClick={this.thrower.bind(this, 'action', [2, this.props.id], this.props.super)} className="act c-vert nocolor-click">
                    ...
                    <div style={{"backgroundColor": " red"}} onClick={this.thrower.bind(this, 'action', [0, this.props.id], this.props.super)} className="act nocolor-click">
                    </div>
                </div>            
            </div>
